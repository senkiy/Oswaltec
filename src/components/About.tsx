        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">
              Com anos de experiência no mercado, a Oswaltec é referência em serviços industriais. Nossa empresa foi fundada com o compromisso de 
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  Fornecer serviços de manutenção industrial com os mais 
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center p-6 bg-earth-brown text-white rounded-lg max-sm:p-3">
                  <div className="text-3xl font-bold mb-2 max-sm:text-lg text-center">Hr. Comercial</div>
