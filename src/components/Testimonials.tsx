  ...
  const testimonials = [
    {
      ...
      text: "A Oswaltec superou nossas expectativas. A segurança e qualidade dos serviços prestados foram impecáveis. Recomendo fortemente!",
      rating: 5,
    ...
    },
    {
      ...
      text: "Profissionalismo e pontualidade são as marcas da Oswaltec. Trabalham com materiais de primeira qualidade e entregam no prazo.",
      rating: 5,
      image: "https://images.unsplash.com/photo-1649972904349-6e44c42644a7?auto=format&fit=crop&w=150&q=80"
    },
    {
